...
- [Extract tables as HTML](/api-reference/partition/legacy-api/text-as-html) (Unstructured API Reference)
...
- [Extract images and tables from documents](/api-reference/partition/legacy-api/extract-image-block-types) (Unstructured API Reference)
...
- [Get chunked elements](/api-reference/partition/legacy-api/get-chunked-elements) (Unstructured API Reference)
