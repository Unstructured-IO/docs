...
- [Get your Unstructured Platform Partition API key](/platform-api/partition-api/overview).
...
<Steps>
    ...
    <Step title="Add the Unstructured component">
        In this step, you add a component that instructs the Unstructured Platform Partition API to process a local file that you specify.
