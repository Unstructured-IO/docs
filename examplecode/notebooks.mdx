...
<CardGroup cols={2}>
    ...
    <Card title="Google Drive to Pinecone" icon="square-6" href="https://colab.research.google.com/drive/1NXvjaW7HDiIOoxtP-FG23k5BD0-d1XCK?usp=sharing">
    <br/>
       Embed your Google Drive Docs in a Pinecone Vector Database with Unstructured
    <br/>
       ``Unstructured`` ``Google`` ``Pinecone`` 
    <br/>
    </Card>
</CardGroup>
