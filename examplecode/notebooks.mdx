...
---
<CardGroup cols={2}>
   <Card title="Unstructured API: On-Demand Jobs Quickstart" href="https://colab.research.google.com/github/Unstructured-IO/notebooks/blob/main/notebooks/Unstructured_API_On-Demand_Jobs_Quickstart.ipynb">
     <br/>
   ...
   <Card title="Unstructured API: On-Demand Jobs Walkthrough" href="https://colab.research.google.com/github/Unstructured-IO/notebooks/blob/main/notebooks/Unstructured_API_On-Demand_Jobs_Walkthrough.ipynb">
     <br/>
