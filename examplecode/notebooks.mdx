...
---
<CardGroup cols={2}>
   <Card title="RAG over Evolving Documents" href="https://colab.research.google.com/github/Unstructured-IO/notebooks/blob/main/notebooks/RAG_over_Evolving_Documents.ipynb">
      <br/>
            Learn how to build a cost-efficient RAG system that automatically detects document changes and processes only what's new or modified, avoiding expensive reprocessing of unchanged files.
      <br/>
         ``Unstructured API`` ``Workflows`` ``RAG`` ``S3`` ``AstraDB`` ``Change Detection`` 
      <br/>
   </Card>
   ...
   <Card title="Everything (from) Everywhere All at Once" href="https://colab.research.google.com/github/Unstructured-IO/notebooks/blob/main/notebooks/RAG_From_Multiple_Data_Sources_FileTypes.ipynb">
    ...
    <br/>
       This notebook walks through using the Unstructured API workflow operations to set up a complete pipeline that pulls documents from S3, processes them using Unstructured, and stores the resulting embeddings in Qdrant for fast vector search and retrieval.
    <br/>
   ...
   <Card title="RAG for Online Documentation" href="https://colab.research.google.com/github/Unstructured-IO/notebooks/blob/main/notebooks/RAG_for_documentation.ipynb">
    ...
    <br/>
       Build an end-to-end workflow in Unstructured programmatically by using the Unstructured API workflow operations.
    <br/>
