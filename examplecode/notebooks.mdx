...
<CardGroup cols={2}>
    ...
    <Card title="LLama3 RAG evaluation on Unstructured Text" icon="square-7" href="https://colab.research.google.com/drive/1qFq0KdZEk-tZcuOXCOcPn0ep-Q9HDJwV?usp=sharing">
    <br/>
       Build a Synthetic Test Dataset for your RAG system in 5 easy steps
    <br/>
    ...
    <Card title="Google Drive to DataStax Astra DB" icon="square-8" href="https://colab.research.google.com/drive/1Img_qGCTKavImbz7dlRtxg8mNUjiWjJT?usp=sharing">
    <br/>
    ...
    <Card title="Weaviate RAG quickstart" icon="square-9" href="https://colab.research.google.com/drive/1w8jLcZFlKCOB86qarvMFf4I86qWE-sRE?usp=sharing">
    <br/>
