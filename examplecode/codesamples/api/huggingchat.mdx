...
[Unstructured JavaScript/TypeScript SDK](/api-reference/partition/legacy-api/sdk-jsts) to send a PDF file to 
the [Unstructured Partition Endpoint](/api-reference/partition/legacy-api/overview) for processing. Unstructured processes the PDF and extracts the PDF's content. 
...
- Your Unstructured API key and API URL. [Get an API key and API URL](/api-reference/partition/legacy-api/overview). 
