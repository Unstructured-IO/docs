...
the [Unstructured Platform Partition API](/platform-api/partition-api/overview) for processing. Unstructured processes the PDF and extracts the PDF's content. 
