...
<Steps>
  ...
  <Step title="Route">
    ...
    - **Auto** instructs Unstructured to automatically analyze and process files on a page-by-page basis:

      - If the page has no tables or images, **Fast** processing is used, and the page is billed at the **Fast** rate for processing.
      - If the page has tables or images with standard layouts and languages, **High Res** processing is used, and the page is billed at the **High Res** rate for processing.
      - If the page has tables or images with complex layouts or languages, **VLM** processing is used, and the page is billed at the **VLM** rate for processing.
