...
- As part of the [Unstructured Python SDK](https://github.com/Unstructured-IO/unstructured-python-client), 
  ...
  If you already have the Unstructured Python SDK installed, upgrade to the latest version by running the following command instead:

  ```bash
  pip install --upgrade unstructured-client
  ```
...
The following Unstructured Python SDK and `curl` examples use environment variables, which you can set as follows:
