...
- **The Unstructured Platform API URL**, which is `http://platform.unstructuredapp.io`
  ...
  <Note>
      ...
      If your API URL is different, be sure to substitute `http://platform.unstructuredapp.io` for your 
...
```bash
export UNSTRUCTURED_API_URL="http://platform.unstructuredapp.io"
...
3. Create two global variables with the following settings:
   ...
   - **Type**: `default`
   - **Initial value**: `http://platform.unstructuredapp.io`
   <br/>
   - **Variable**: `UNSTRUCTURED_API_URL`
   - **Type**: `secret`
