---
title: Databricks
description: This page contains the information to store processed data to Databricks.
---
...
For more information, please refer to [Databricks documentation](https://docs.databricks.com/).

## Step-by-Step Guide

![Destination Connector Databricks](https://unstructured-io.github.io/unstructured/_images/Destination-Databricks.png)
...
*   `Host` (_required_): Enter the Databricks workspace host URL.
...
*   `Catalog` (_required_): Name of the catalog in the Databricks Unity Catalog service.
    
*   `Schema`: Specify the schema associated with the volume.
    
*   `Volume` (_required_): Name of the volume in the Unity Catalog.
