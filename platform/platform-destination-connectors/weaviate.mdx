...
Ensure that the index schema is compatible with the data you intend to write. If you need guidance on structuring your schema, consult the [Sample Index Schema](/open-source/ingest/destination-connectors/weaviate#sample-index-schema) for reference.
</Warning>

## Step-by-Step Guide

![Destination Connector Weaviate](img/platform/Destination-Weaviate.png)
