---
title: OpenSearch 
description: This page contains the information to store processed data to an OpenSearch cluster.
---
...
Ensure that the index schema is compatible with the data you intend to write. If you need guidance on structuring your schema, consult the [Vector Search Sample Mapping](https://unstructured-io.github.io/unstructured/ingest/destination_connectors/opensearch.html#vector-search-sample-mapping) for reference.
</Warning>

## Step-by-Step Guide

![Destination Connector OpenSearch](https://unstructured-io.github.io/unstructured/_images/Destination-OpenSearch.png)
...
*   `Hosts` (_required_): Enter the comma-delimited list of OpenSearch hosts.
    
*   `Index Name` (_required_): Provide the name of the index where the data will be stored.
