...
Ensure that the index schema is compatible with the data you intend to write. If you need guidance on structuring your schema, consult the [Sample Index Schema](https://unstructured-io.github.io/unstructured/ingest/destination_connectors/sql.html#sample-index-schema) for reference.
</Warning>

## Step-by-Step Guide

![Destination Connector PostgreSQL](https://unstructured-io.github.io/unstructured/_images/Destination-PostgreSQL.png)
