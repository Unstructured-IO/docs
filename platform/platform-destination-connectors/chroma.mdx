---
title: Chroma 
description: This page contains the information to store processed data to a Chroma instance.
---
...
For more information, please refer to [Chroma documentation](https://docs.trychroma.com/getting-started).

## Step-by-Step Guide

![Destination Connector Chroma](https://unstructured-io.github.io/unstructured/_images/Destination-Chroma.png)
...
*   `Collection Name` (_required_): Specify the name of the collection to write into.
    
*   `Batch Size` (_required_): Define the number of records per batch to write into Chroma.    
</Note>
