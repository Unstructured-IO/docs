...
Ensure that the index schema is compatible with the data you intend to write. If you need guidance on structuring your schema, consult the [Vector Search Sample Mapping](/open-source/ingest/destination-connectors/elasticsearch#vector-search-sample-mapping) for reference.
</Warning>

## Step-by-Step Guide
![Destination Connector Elasticsearch](img/platform/Destination-Elasticsearch.png)
