...
![job dashboard](https://unstructured-io.github.io/unstructured/_images/04a-Job-Dashboard.png)
...
![create adhoc job](https://unstructured-io.github.io/unstructured/_images/04b-Create-Adhoc-Job.png)
...
![job detail status](https://unstructured-io.github.io/unstructured/_images/04c-Jobs-Detail-Status.png)

The Job Details page is a comprehensive section for monitoring the specific details of jobs executed within a particular workflow. To access this page, click the specific _Workflow_ or _ID_ on the Job Dashboard.
