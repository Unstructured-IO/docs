...
and [chunking strategy and settings](/platform/chunking) for your source files and data documents and records. 
...
sampling of files or data documents or records from the source location, depending on the connector's type. Unstructured then recommends 
