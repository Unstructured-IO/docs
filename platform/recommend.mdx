...
Unstructured makes recommendations from among its list of preapproved embedding models. You cannot include unapproved 
embedding models in the recommendation process. Nor can you restrict the process to consider only specific preapproved models, 
specific numbers or ranges of dimensions, or other criteria.

To make its recommendation, Unstructured uses the [Hi-res partitioning strategy](/platform/partitioning) to process and then analyze up to 50 files that 
it randomly chooses from the specified source location. Your Unstructured account is charged at the **Hi-res** rate for this activity.
...
3. Make a note of the number of dimensions for the model that you selected. [View the number of dimensions by model](/platform/embedding#generate-embeddings).
...
4. Make a note of the number of dimensions displayed for the model that you selected. [View the number of dimensions by model](/platform/embedding#generate-embeddings).
