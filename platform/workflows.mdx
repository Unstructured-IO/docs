...
16. In the **Embed** area, for **Provider**, choose one of the following:
    ...
    - **Amazon Bedrock**: Use [Amazon Bedrock](https://aws.amazon.com/bedrock) to generate embeddings. Also, choose the model to use:
...
<AccordionGroup>
    ...
    <Accordion title="Embedder node">
        ...
        - **Amazon Bedrock**: Use Amazon Bedrock to generate embeddings. Also, choose the model to use:
