...
This automatic workflow performs only **Auto** [partitioning](/platform/partitioning) by default. Unstructured uses the following formula for **Auto** partitioning:
