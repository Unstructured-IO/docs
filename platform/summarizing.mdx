...
After [partitioning](/platform/partitioning) and [chunking](/platform/chunking), _summarizing_ generates text-based summaries of images and tables. 
...
- **OpenAI Table Description**: Use GPT-4o to summarize tables. [Learn more](https://openai.com/index/hello-gpt-4o/).
