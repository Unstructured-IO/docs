...
To summarize images and tables, in the **Transform** section of a workflow, specify the following:

<Note>You can change a workflow's summarization settings only through [Custom](/platform/workflows#custom-workflow-settings) workflow settings.</Note>

For image summarization, in the **Image summarization** area, choose one of the following:

- **None**: No image summarization. This is the default.
...
For table summarization, in the **Table summarization** area, choose one of the following:

- **None**: No table summarization. This is the default.
