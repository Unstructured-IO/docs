...
<Warning>
    ...
    If you do not have an existing connector for either your target source (input) or destination (output) location, [create the source connector](/platform/platform-source-connectors/overview), [create the destination connector](/platform/platform-destination-connectors/overview), and then return here.
