...
<AccordionGroup>
    <Accordion title="Transform section">
        1. For **Strategy**,
        2. For **Image summarization**,
        3. For **Table summarization**,
        4. For **ConnectorSettings**,
        5. For **Elements to Exclude**,
    </Accordion>
