...
<AccordionGroup>
    ...
    <Accordion title="Embed section">
        For **Vendor**, select one of the the following:
    ...
    <Accordion title="Schedule section">
        ...
        - **Off**: This worklow will not run automatically. To run this workflow, [create and run a job manually](/platform/jobs-scheduling).
        ...
        - **Frequently**: This workflow will automatically run once after each specified number of minutes. Choose the time period in minutes to wait until running this worklow again.
    </Accordion>
</AccordionGroup>

## Edit, delete, or run a workflow

![Manage a worklow](/img/platform/Workflow-Actions.png)
