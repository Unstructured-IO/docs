---
title: Elasticsearch 
description: This page contains the information to ingest your data from Elasticsearch.
---
...
![Source Connector Elasticsearch](https://unstructured-io.github.io/unstructured/_images/Source-Elasticsearch.png)
...
<Note>
*   `Name` (_required_): Enter a unique name for the Elasticsearch source connector.
    
*   `URL` (_required_): Specify the Elasticsearch cluster URL.
    
*   `Batch Size` (_required_): Set the number of records the platform will process in a single batch.
    
*   `Index Name` (_required_): Provide the name of the index in the Elasticsearch cluster.
