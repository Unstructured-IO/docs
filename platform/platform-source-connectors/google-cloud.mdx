...
description: This page contains the information to ingest your data from Google Cloud Storage.
---
...
![Source Connector Google Cloud Storage](https://unstructured-io.github.io/unstructured/_images/Source-Google-Cloud.png)
...
<Note>
*   `Name` (_required_): Enter a unique name for the Google Cloud Storage source connector.
    
*   `Remote URL` (_required_): Specify the gs:// URL pointing to your Google Cloud Storage bucket and path.
    
*   `Service Account Key` (_required_): Enter the JSON content of a Google Service Account Key that has the necessary permissions to access the specified bucket.
