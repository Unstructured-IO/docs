...
<Warning>
    ...
    Unstructured recommends that you use the [Unstructured Platform](/platform-api/overview) API instead, which provides for 14 days of free usage at up to 1000 pages per day during that period.
</Warning>
...
To work with Unstructured by using the [Unstructured Python library](/ingestion/overview#unstructured-ingest-python-library), you will need to:
