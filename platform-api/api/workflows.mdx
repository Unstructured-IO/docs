...
To use the [Unstructured Platform Workflow API](/platform/api/overview) to manage workflows, do the following:
...
understand the [basics](/platform/api/overview#basics) of working with the Unstructured Platform Workflow API.
