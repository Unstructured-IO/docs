...
- For the [Unstructured Platform Workflow Endpoint](/platform/api/overview), the API URL is typically `https://platform.unstructuredapp.io/api/v1`.
...
For the API key, the same API key works for both the [Unstructured Platform Workflow Endpoint](/platform/api/overview) key or [Unstructured Platform Partition Endpoint](/platform-api/partition-api/overview). This API key is in your Unstructured account dashboard. To access your dashboard:
