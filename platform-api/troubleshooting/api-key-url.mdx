...
- For the [Unstructured Platform Partition API](/platform-api/partition-api/overview) or the [Unstructured Platform API](/platform/api/overview), the API key is in your dashboard. To access your dashboard:
