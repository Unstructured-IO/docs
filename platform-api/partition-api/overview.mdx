...
<Note>
    The Unstructured Platform Partition API is separate from the Unstructured Platform Workflow API. 
    
    For information about the 
    Unstructured Platform Workflow API, see the [Unstructured Platform Workflow API Overview](/platform-api/api/overview).
</Note>
