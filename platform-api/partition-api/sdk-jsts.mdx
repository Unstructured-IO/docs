...
The [Unstructured JavaScript/TypeScript SDK](https://github.com/Unstructured-IO/unstructured-js-client) client allows you to send an individual file for processing by the Unstructured Platform Partiiton API.
