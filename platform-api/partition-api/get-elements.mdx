...
You want to get, manipulate, and print or save, the contents of the [document elements and metadata](/latform-api/partition-api/document-elements) from the processed data that Unstructured returns.
