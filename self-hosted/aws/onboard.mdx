...
Decide whether you want Unstructured to do one of the following:

- Have Unstructured set up the necessary infrastructure within your AWS account first and then deploy Unstructured user interface (UI) and API into 
  that infrastructure. This is commonly refererred to as the "[do it all for me](#do-it-all-for-me)" approach.
- Set up the necessary infrastructure within your AWS account yourself first and then have Unstructured deploy the Unstructured UI and API into your 
  existing infrastructure. This is commonly referred to as the "[bring my own infrastructure](#bring-my-own-infrastructure)" approach.

### Do it all for me


You have reached the end of the "do it all for me" checklist.
