...
Decide which approach you want Unstructured to take:

- Have Unstructured set up the necessary infrastructure within your GCP account first and then deploy Unstructured user interface (UI) and API into 
  that infrastructure. This is commonly refererred to as the "[do it all for me](#do-it-all-for-me)" approach.
- Set up the necessary infrastructure within your GCP account yourself first and then have Unstructured deploy the Unstructured UI and API into your 
