...
and the [Unstructured API](/api-reference/overview) on infrastructure that you maintain in your Amazon Web Services (AWS), Azure, 
or Google Cloud Platform (GCP) account. 
...
[Google Cloud Platform (GCP)](/self-hosted/gcp/overview) accounts.
