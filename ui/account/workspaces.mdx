...
Each account user must be explicitly added to each workspace that they are allowed to access. This assumes that the account user has first been added 
...
_Personal API keys_ for account users' personal accounts do not work for making API calls to workspaces. Workspace API keys for workspaces do not work for making API calls to personal accounts.
