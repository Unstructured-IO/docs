...
![Jobs in the sidebar](/img/ui/Jobs-Sidebar.png)
...
![Pending job icon](/img/ui/Job-Pending.png) **Pending**: The job's data is currently not attempting to be processed.
![In-progress job icon](/img/ui/Job-In-Progress.png) **In Progress**: The job's data is attempting to be processed.
![Fully finished job icon](/img/ui/Job-Finished-Fully.png) **Finished**: 100% of the job's data has been successfully processed.
![Partially finished job icon](/img/ui/Job-Finished-Partially.png) **Finished**: 90% to 99% of the job's data has been sucessfully processed.
![Failed job icon](/img/ui/Job-Failed.png) **Failed**: Less than 90% of the job's data has been successfully processed.
