...
| `image_base64`             | A Base64 representation of the detected image or table. Only applicable to image and table elements when High Res partitioning is used. If `orig_elements` is also produced, the `image_base64` content is output into `orig_elements`.                                                                                                                                                                                                                                                                                    |
