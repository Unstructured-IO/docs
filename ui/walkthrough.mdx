...
4. Repeat this process to add three more nodes between the **Partitioner** and **Destination** nodes. To do this, click 
   ...
   a. Add a **Table** (under **Input Type**) enrichment node with **OpenAI (GPT-4o)** (under **Model**) and **Table Description** (under **Task**) selected.<br/>
   b. Add another **Table** (under **Input Type**) enrichment node with **OpenAI (GPT-4o)** (under **Model**) and **Table to HTML** (under **Task**) selected.<br/>
   c. Add a **Text** (under **Input Type**) enrichment node with **OpenAI (GPT-4o)** (under **Model**) selected.<br/>
...
Unstructured also offers an API and SDKs, which allows you to work with Unstructured programmatically. For details, see:
