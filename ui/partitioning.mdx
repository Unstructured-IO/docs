...
For handwriting, the **High Res** strategy typically produces unusable results, for example failing to properly recognize Japanese hiragana:

![The High Res strategy typically produces unusable results for handwriting](/img/partitioning/Handwriting-Hi-Res.png)

For multilanguage characters, the **High Res** strategy also typically produces unusable results:
...
The **VLM** strategy also has great support for recognizing multilanguage characters, such as this example that uses GPT-4o by OpenAI to recognize Japanese hiragana:
