...
Unstructured `Source Connectors` make data ingestion easy. They ensure that your data is accessible, up to date, and usable for any downstream task. If you’d like to read more on our source connectors, you can find details [here](/ingestion/source-connectors/overview).
...
1.  **Data ingestion**: The first step is acquiring data from your relevant sources. We make this easy with our [source connectors](/ingestion/source-connectors/overview).
