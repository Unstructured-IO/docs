...
<Steps>
    ...
    <Step title="Define the workflow">
        1. In the sidebar, click **Worfklows**.
        2. Click **New Workflow**.
        3. Enter a **Name** for the new workflow.
        4. In the **Sources** dropdown list, select your source location from Step 2.
        5. In the **Destination** dropdown list, select your destination location from Step 3.
        ...
        6. Fill in the rest of the fields with any non-default settings. [Learn more](/platform/workflows-automation#create-a-workflow).
        7. Click **Submit**.
    </Step>
    <Step title="Process the documents">
        1. In the sidebar, click **Jobs**.
        2. Click **Run Job**.
        3. In the **Select a Workflow** dropdown list, select your workflow from Step 4.
        4. Click **Run**. 
    </Step>
