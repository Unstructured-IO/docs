...
<Steps>
    ...
    <Step title="Define the workflow">
        ...
        6. In the **Workflow Settings** section, choose one of these predefined workflow settings groups:
           ...
           Learn about the predefined settings for [Basic](/platform/workflows-automation#basic-workflow-settings) and [Advanced](/platform/workflows-automation#advanced-workflow-settings).
           ...
           Learn how to define [Custom](/platform/workflows-automation#custom-workflow-settings) workflow settings.
