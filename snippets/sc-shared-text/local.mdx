Connect local files to your preprocessing pipeline, and use the Unstructured Ingest CLI or Unstructured Ingest Python to batch process all your documents and store structured outputs locally on your filesystem.
