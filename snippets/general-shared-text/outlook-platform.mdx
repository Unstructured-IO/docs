...
- **Client ID** (_required_): The client ID of the Microsoft Entra ID application that has access to the Outlook email account address.
- **Client Credential** (_required_): The secret ID of the corresponding Entra ID application.
...
- **Tenant**: The ID or domain name that is associated with the Entra ID application. If this field is left blank, `common` is used by default.
