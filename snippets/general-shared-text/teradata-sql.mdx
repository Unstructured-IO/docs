...
- The name of the target table in the database. To get a list of available tables in a database, you can run a query such as the following, replacing `<database-name>` with the name of the target database:
  ...
  To create a table that is compatible with Unstructured, you can adapt the following table schema example for your own needs, replacing `<database-name>` with the name of the target database:
