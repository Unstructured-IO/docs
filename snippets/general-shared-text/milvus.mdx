...
- The name of the [collection](https://milvus.io/docs/manage-collections.md) in the database.
  ...
  schema for Unstructured contains only the fields `element_id` and `embeddings`, as follows. This example code demonstrates the use of the 
  ...
  Other approaches, such as [creating collections instantly](https://milvus.io/docs/create-collection-instantly.md), 
  [enabling dynamic fields](https://milvus.io/docs/enable-dynamic-field.md), or 
