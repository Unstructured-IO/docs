...
Here is a collection schema definition for an example collection named `Elements` that can handle many (but not all) of the JSON objects that Unstructured outputs. 

You must adjust these properties and datatypes for your specific needs. 
