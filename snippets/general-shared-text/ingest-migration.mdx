The older `unstructured` versions of the [Unstructured Ingest CLI](/ingestion/overview#unstructured-ingest-cli) and [Unstructured Ingest Python library](/ingestion/python-ingest) have been replaced and are now deprecated.
