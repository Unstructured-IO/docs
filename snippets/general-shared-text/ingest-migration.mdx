The older `unstructured` versions of the [Unstructured Ingest CLI](/open-source/ingestion/overview#unstructured-ingest-cli) and [Unstructured Ingest Python library](/open-source/ingestion/python-ingest) have been replaced and are now deprecated.
