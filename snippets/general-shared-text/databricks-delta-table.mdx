...
- Within Unity Catalog:
  ...
  - A table 
    ...
    - Leave the table name blank. The connector will attempt to create a table named `unstructuredautocreated` within the specified catalog and schema (formerly known as a database).
