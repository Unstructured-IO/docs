<Info>
    If you do not specify the API URL, the [Unstructured Partition Endpoint](/api/partition/overview) URL of `https://api.unstructuredapp.io/general/v0/general` is used by default. You must always specify your Partition Endpoint key.<br/><br/>
