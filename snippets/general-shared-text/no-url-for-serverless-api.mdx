<Info>
    If you do not specify the API URL, the legacy [Unstructured Partition Endpoint](/api-reference/legacy-api/partition/overview) URL of `https://api.unstructuredapp.io/general/v0/general` is used by default. You must always specify your legacy Partition Endpoint key.<br/><br/>
