<Info>
    If you do not specify the API URL, the [Unstructured Platform Partition API](/platform-api/partition-api/overview) URL of `https://api.unstructuredapp.io/general/v0/general` is used by default. You must always specify your Platform Partition API key.<br/><br/>
