...
- `AZURE_STORAGE_ACCOUNT_NAME` - The name of the Azure Storage account. [Create a storage account](https://learn.microsoft.com/azure/storage/common/storage-account-create#create-a-storage-account).
