...
5. Unstructured's initial results are based on its **High Res** [partitioning strategy](/ui/partitioning), which 
   ...
   This partitioning strategy also generates a bounding box for each detected object in the file. A _bounding box_ is 
   ...
   ![Seeing the initial results updated with the enrichments](/img/ui/single-file/apply-generative-refinement.png)
