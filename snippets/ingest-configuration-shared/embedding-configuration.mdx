...
*   <Icon icon="v"/><Icon icon="2"/>&nbsp;&nbsp;`embedding_provider`: The embedding provider to use while doing embedding. Available values include `openai`, `huggingface`, `aws-bedrock`, `togetherai`, `vertexai`, `voyageai`, and `octoai`.
...
*   <Icon icon="v"/><Icon icon="1"/>&nbsp;&nbsp;`provider`: The embedding provider to use while doing embedding. Available values include `openai`, `huggingface`, `aws-bedrock`, `togetherai`, `vertexai`, `voyageai`, and `octoai`.
