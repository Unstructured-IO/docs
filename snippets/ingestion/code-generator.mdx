...
4. Select your chunking strategy from the **Chunking strategy** drop-down list:
   ...
   To learn more, see [Chunking strategies](/api-reference/partition/legacy-api/chunking) and [Chunking configuration](/open-source/ingestion/ingest-configuration/chunking-configuration).
