...
5. To get your API key, click the copy icon in the **Actions** column for your API key. Store your copied API key in a secure location.
6. To get your API URL, click the copy icon next to the URL next to **API URL**. Store your copied API URL in a secure location.
...
[Try the quickstart](#quickstart-example).
