...
To work with the Unstructured Serverless API by calling the Unstructured REST API POST operation, you will need to set the `UNSTRUCTURED_API_KEY` environment variable to your Unstructured API key.
