...
*   **More Details**: For comprehensive information, visit the [Partition via API Documentation](https://unstructured-io.github.io/unstructured/core/partition.html#partition-via-api).
