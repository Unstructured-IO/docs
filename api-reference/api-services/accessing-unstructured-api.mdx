...
* [Using API from `partition_via_api`](/api-reference/api-services/partition-via-api)
...
If you'd like to try out the Unstructured API interactively, you can do so via [Swagger UI](https://api.unstructured.io/general/docs#/default/pipeline_1_general_v0_general_post).
