...
<Warning>
  The secret is shown in the response payload of this operation. This secret is shown only once. If you forget this secret, 
  you can get a new, replacement one by [rotating this workspace-scoped notification channel's secret](#rotate-the-secret-for-a-workspace-scoped-notification-channel).
</Warning>
...
<Warning>
  The secret is shown in the response payload of this operation. This secret is shown only once. If you forget this secret, 
  you can get a new, replacement one by [rotating this workflow-scoped notification channel's secret](#rotate-the-secret-for-a-workflow-scoped-notification-channel).
</Warning>
