...
<Note>
    The default URL for the Unstructured Worfklow Endpoint is `https://platform.unstructuredapp.io/api/v1`. However, this URL might not necessarily work for your account.
</Note>
...
<Tip>
    ...
    This URL (`https://platform.unstructuredapp.io`)might not necessarily work for your account. You should use the URL that was provided to you when your Unstructured account was created. 
    If you do not have this URL, contact Unstructured Sales at [sales@unstructured.io](mailto:sales@unstructured.io).
</Tip>
