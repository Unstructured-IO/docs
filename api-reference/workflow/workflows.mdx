...
To use the [Unstructured API workflow operations](/api-reference/workflow/overview) to manage workflows, do the following:
...
understand the [basics](/api-reference/workflow/overview#basics) of working with the Unstructured API workflow operations.
