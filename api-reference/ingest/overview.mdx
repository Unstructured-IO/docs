...
```mermaid
  flowchart TB
    id1[1. Ingest]-->id2[2. Post-Index Filter]-->id3[3. Download]-->id4[4. Post-Download Filter]-->id5[5. Uncompress]-->id6[6. Post-Uncompress Filter]-->id7[7. Partition]-->id8[8. Chunk]-->id9[9. Embed]-->id10[10. Stage]-->id11[11. Upload]
```
<Steps>
    <Step title="Index">
