...
<Steps>
    ...
    <Step title="Specify one of the following models...">
        ...
        - `layout_v1.1.0` generally performs better than `yolox` at bounding box definitions and element classification. `layout_v1.1.0` is a propietary Unstructured object detection model and is used by default, as applicable, if `--hi-res-model-name`, `hi_res_model_name`, or `hiResModelName` is not specified.
