...
You want to get, and print or save, the elements that were originally used to derive a chunked element.
...
- [Chunking strategies](/api-reference/api-services/chunking)