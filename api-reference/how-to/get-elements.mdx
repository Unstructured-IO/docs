...
<AccordionGroup>
    <Accordion title="Python SDK">
        ...
        To serialize this list as JSON, you can use the standard [json](https://docs.python.org/3/library/json.html#module-json) `dumps` method to serialize it to JSON-formatted string or the `dump` method to save it as a JSON-formatted stream to a file.
    ...
    <Accordion title="JavaScript/TypeScript SDK">
        ...
        You can also use standard `Array` techniques such as [forEach](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array/forEach) to access each object in this array. 
    ...
    <Accordion title="Open source library">
        Calling the `partition_via_api` function returns a list of `Element` objects (`list[Element]`).
        ...
        To serialize this list as a Python dictionary, you can use Python [list comprehension]() and `to_dict`, for example:
