...
Use the [Unstructured Python SDK](/api-reference/api-services/sdk) to extract the Base64-encoded representation of specific elements, such as images and tables, in the document. 
