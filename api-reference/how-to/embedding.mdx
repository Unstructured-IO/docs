...
You can use the [Unstructured Ingest CLI]() or the [Unstructured Ingest Python library]() to generate embeddings after the partitioning step in an ingest pipeline. You do this by 
