...
<Tip>
    ...
    or run anything on your local machine, you can skip over to the notebook [Unstructured API Quickstart](https://github.com/Unstructured-IO/notebooks) instead. 
...
[Unstructured API On-Demand Jobs Walkthrough](https://github.com/Unstructured-IO/notebooks), running remotely in Google Colab. This notebook requires no local setup.
