...
<Tip>
    ...
    or run anything on your local machine, you can skip over to the notebook [Unstructured API On-Demand JobsQuickstart](https://colab.research.google.com/github/Unstructured-IO/notebooks/blob/main/notebooks/Unstructured_API_On-Demand_Jobs_Quickstart.ipynb) instead. 
...
[Unstructured API On-Demand Jobs Walkthrough](https://colab.research.google.com/github/Unstructured-IO/notebooks/blob/main/notebooks/Unstructured_API_On-Demand_Jobs_Walkthrough.ipynb), running remotely in Google Colab. This notebook requires no local setup.
