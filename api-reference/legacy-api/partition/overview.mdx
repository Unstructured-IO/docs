...
<Tip>
    To start using the Unstructured Partition Endpoint right away, skip ahead to the [quickstart](/api-reference/partition/legacy-api/quickstart) now!
</Tip>
...
at a time. Use the [Unstructured API workflow operations](/api-reference/workflow/overview) for production-level scenarios, file processing in 
...
<Tip>
    ...
    [skip ahead](/api-reference/partition/legacy-api/quickstart) to the SDK version instead.
</Tip>
...
You can also call the Unstructured Partition Endpoint by using the [Unstructured Python SDK](/api-reference/partition/legacy-api/sdk-python) or the [Unstructured JavaScript/TypeScript SDK](/api-reference/partition/legacy-api/sdk-jsts).