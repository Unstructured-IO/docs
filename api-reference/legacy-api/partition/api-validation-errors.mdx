...
For the [Unstructured Python SDK](/api-reference/partition/legacy-api/sdk-python), 
the [Unstructured Partition Endpoint](/api-reference/partition/legacy-api/overview) returns errors primarily through 
