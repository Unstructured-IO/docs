...
<Tip>
    ...
    Unstructured API workflow operations instead.
</Tip>
...
The following code shows how to use the [Unstructured Python SDK](/api-reference/partition/legacy-api/sdk-python) 
to have Unstructured process one or more local files by using 
the [Unstructured Partition Endpoint](/api-reference/partition/legacy-api/overview). 

To run this code, you will need the following:

- An Unstructured account and an Unstructured API key for your account. [Learn how](/api-reference/partition/legacy-api/overview#get-started).
...
some of Unstructured's [partitioning](/api-reference/partition/legacy-api/partitioning) strategies, with limited support for [chunking](/api-reference/partition/legacy-api/chunking). 
It is designed to work only with processing of local files.

Take your code to the next level by switching over to the [Unstructured API workflow operations](/api-reference/workflow/overview) 
