...
- **Independent ingress and outbound** means you can access the platform over the internet with the UI or API, while Unstructured uses PrivateLink to reach your data sources.  The two paths are configured separately.
...
<Warning>
!! WRITER:  Check formatting for "Optional" in titles !!
</Warning>
...
<note>
Enabling public ingress or egress reduces the network isolation benefits of a Dedicated Instance. Unstructured recommends using PrivateLink for all connectivity where possible.
</note>