...
<Callout icon="arrow-right" color="#9900ff" iconType="regular">!!WRITER: check standard wording and links for submitting support ticket or reference to Customer Portal. </Callout>
