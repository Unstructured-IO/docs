---
title: Onboarding in-VPC on your Microsoft Azure platform
sidebarTitle: Onboarding in-VPC
---
...
<Note>
    ...
    the [onboarding process for Azure Private Link](/business/azure/azure-privatelink/onboarding-di-pl).
</Note>
...
- `Microsoft.Network/networkSecurityGroups/write` (to create the Network Security Groups)
- `Microsoft.Network/networkSecurityGroups/read` (to read the Network Security Groups)
