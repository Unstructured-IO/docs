...
- For dedicated instance deployments with AWS PrivateLink, follow the [onboarding checklist for a dedicated instance](/business/aws/aws-privatelink/onboarding-preparing). 
