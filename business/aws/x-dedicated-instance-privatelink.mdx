---
title: (TO BE ARCHIVED)- Unstructured Business dedicated instance on Amazon Web Services (AWS) with PrivateLink - onboarding
sidebarTitle: (TO BE ARCHIVED) Dedicated instance + PrivateLink onboarding
---

<Callout icon="arrow-right" color="#9900ff" iconType="regular">!!WRITER COMMENT: This content will be removed before publish.  Keeping it around for Review reference.</Callout>
