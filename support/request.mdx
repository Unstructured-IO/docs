...
- If you are using the [Unstructured open source library](/open-source/introduction/overview), 
  request support by creating a new message in 
  one of the channels in the [Unstructured Slack community](https://short.unstructured.io/pzw05l7).
...
- For Unstructured [Enterprise](/enterprise/overview) accounts, including dedicated instance and in-VPC accounts, 
  contact your assigned Unstructured Account Executive (AE) or Customer Success Manager (CSM). 
