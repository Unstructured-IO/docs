...
<Steps>
    ...
    <Step title="Get your API key and API URL">
        ...
        2. Your Unstructured API URL is an empty string.
    </Step>
    <Step title="Set enviromnent variables">
        ...
        2. Set another environment variable named `UNSTRUCTURED_API_URL` to an empty string.<br/><br/>
...
<Info>The open source library is [limited](/open-source/introduction/overview#limits) compared to the Platform and API service products.</Info>
