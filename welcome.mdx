...
<Tip>
    This quickstart uses the Unstructured API's [Partition Endpoint](/api-reference/partition/legacy-api/overview) and focuses on a single, local file for ease-of-use demonstration purposes. This quickstart also 
    ...
    Unstructured API's [workflow operations](/api-reference/workflow/overview) instead.
</Tip>
...
<Icon icon="code" />&nbsp;&nbsp;[Get the sample code for this video](/api-reference/partition/legacy-api/quickstart#sample-code).

<Icon icon="gear" />&nbsp;&nbsp;[Get the full setup instructions for this video](/api-reference/partition/legacy-api/quickstart).
