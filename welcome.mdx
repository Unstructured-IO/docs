...
1. **Done!** If you'd like a deeper dive on the API, see the detailed [API Documentation](/api-reference/api-services/overview "API"). For more on what partitioning strategies are and why they are important, check out the  [Partioning Strategies](/api-reference/api-services/partitioning "Partioning Strategies") guide.
