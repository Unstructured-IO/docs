...
<Steps>
    <Step title="Sign up">
        Go to the [Developers]() page and enter your information.

        <Note>
            By signing up through the [Developers]() page, your Unstructured account will run within the context of the Unstructured Platform on 
            ...
            start a prepaid subscription in exchange for usage rate discounts.
            ...
            stop here and sign up through the [Enterprises]() page instead.
        </Note>
    </Step>
    <Step title="Sign in">
        ![Sign in to your Unstructured account](/img/platform/Signin.png)
        1. After you have signed up through the [Developers]() page, the Unstructured Platform sign-in page appears.

           <Note>
              If you signed up through the [Enterprises]() page instead, your sign-in process might 
              be different. For enterprise sign-in guidance, consult your Unstructured contact.
           </Note>

        2. Click **Google** or **GitHub** to sign in with the Google or GitHub account that you signed up with through the **Developers** page. 
