...
<Steps>
    <Step title="Sign up">
        Sign up for an Unstructured account by going to the [For Developers](https://unstructured.io/developers) page and choosing one of the following plans:
        ...
        <Note>
            ...
            Unstructured's own hosted cloud resources. 
            
            If you choose a pay-per-page plan, after your first 14 days of usage or more than 1,000 processed pages per day, 
            whichever comes first, your account is then billed at Unstructured's standard service usage rates. You must provide 
            Unstructured with your payment details to keep using the service.
            ...
            If you would rather use Unstructured within the context of your own virtual private cloud (VPC), 
    ...
    <Step title="Sign in">
        ...
        1. After you have signed up through the [For Developers](https://unstructured.io/developers) page, the Unstructured account sign-in page appears.
