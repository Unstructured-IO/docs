...
<Steps>
    ...
    <Step title="Run the code">
        ...
        <Info>The Python SDK works with only a single file. To process multiple files at a time, use the [Unstructured Python Ingest CLI](/ingestion/overview#unstructured-ingest-cli) or [Unstructured Ingest Python](/ingestion/overview#unstructured-ingest-python) instead.</Info>
    </Step>
...
<Steps>
    ...
    <Step title="Run the code">
        ...
        <Info>To process multiple files at a time, use the [Unstructured Python Ingest CLI](/ingestion/overview#unstructured-ingest-cli) or [Unstructured Ingest Python](/ingestion/overview#unstructured-ingest-python) instead.</Info>
    </Step>
    <Step title="View the processed data">
        Go to your destination location to view the processed data.
    </Step>
