---
title: Unstructured Enterprise in-VPC on Google Cloud Platform (GCP) - overview
...
This agreement outlines the terms and conditions for your organization to use Unstructured in an Enterprise environment.
...
see the [onboarding checkist](/enterprise/gcp/onboard).
