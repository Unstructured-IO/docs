...
- **VLM Strategy**: $30 per 1000 pages processed

    Provides the highest accuracy for parsing image and PDF files by using visual language models (VLMs). Files that are not images or PDFs are processed by using the **Hi-Res** strategy and are charged at the **Hi-Res** rate instead.
