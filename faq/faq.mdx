...
unstructured data like documents and images. We've relaunched our SaaS API with a new serverless architecture, per-page
...
Unstructured SaaS API supports using the Chipper models. To define the model, you can pass the hi_res_model_name as shown in the following example:
