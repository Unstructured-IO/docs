...
To install `unstructured`, you'll also need to install the following system dependencies: libmagic, poppler-utils, libreoffice, pandoc, and tessearct.
Instruction details for these depdendencies will vary by operating system. We recommend
