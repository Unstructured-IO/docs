...
If you are using the [Unstructured Partition Endpoint](/api-reference/legacy-api/partition/overview), you can use the `api_url` kwarg to point the `partition_via_api` function at your Unstructured Partition URL.
