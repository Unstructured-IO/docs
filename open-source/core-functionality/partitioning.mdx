...
If you are using the [Unstructured Platform Partition API](/platform-api/partition-api/overview), you can use the `api_url` kwarg to point the `partition_via_api` function at your Unstructured Platform Partition URL.
