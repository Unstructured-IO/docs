---
title: Quick Start
description: This guide offers concise steps to swiftly install and validate your `unstructured` installation. For more comprehensive installation guide, please refer to [this page](http://localhost:63342/CHANGELOG.md/docs/build/html/installing.html).
---
## Installation
...
1.  **Installing the Python SDK**: You can install the core SDK using pip:
    ...
    If you need to process other document types, you can install the extras required by following the [Full Installation](/installation/full-installation)
