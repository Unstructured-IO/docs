...
<Note>The `unstructured` open source library is designed as a starting point for quick prototyping and has [limits](#limits). For production scenarios, see the [Unstructured Platform API](/platform-api/overview) and the [Unstructured Platform](/platform/overview).</Note>
...
The open source library allows you to make calls to the Unstructured Platform Partition API. If you do plan to make such calls, please note:
