...
<Note>
    ...
    The `unstructured` library is designed as a starting point for quick prototyping. For production scenarios, see
    [Unstructured API Services](/api-reference/api-services/overview) and [Unstructured Platform](/platform/overview).
    These solutions include the library's functionality, and offer:
    * **Significantly improved performance on document and table extraction**
    * Access to our latest and continuously improving visitation transformer models
    * **Security and SOC2 compliance**
    * Authentication and identity management
    * Incremental data loading
    * ETL job scheduling and monitoring
    * Image extraction from documents
    * Improved document hierarchy detection
    * and more!
</Note>
