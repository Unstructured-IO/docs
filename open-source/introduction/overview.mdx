...
<Note>
    ...
    The `unstructured` library is designed as a starting point for quick prototyping. For production scenarios, check
    out the [Unstructured API Services](/api-reference/api-services/overview) and [Unstructured Platform](/platform/overview).
    These solutions include the library's functionality, and offer:
    * Security and SOC2 compliance
    * High performance table extraction
