...
* No support for generating embeddings in the core [Unstructured](https://github.com/Unstructured-IO/unstructured) open source offering. (However, there is some support for generating embeddings by using the open source's 
  ...
  [Learn more](/open-source/ingestion/ingest-configuration/embedding-configuration).)
