...
- **voyage-4-large**: Best retrieval quality in the voyage-4 series for demanding multilingual and general-purpose tasks
- **voyage-4**: Balanced general-purpose and multilingual retrieval with higher throughput than voyage-4-large
- **voyage-4-lite**: Best performance-to-cost ratio with the highest batch throughput (1M tokens/batch)
- **voyage-3.5**: General-purpose embeddings with high token limits
