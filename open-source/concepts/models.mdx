...
The `hi_res_model_name` parameter supports the `yolox` argument. YOLOX is a single-stage real-time object detector that modifies YOLOv3 with a DarkNet53 backbone.
